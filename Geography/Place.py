...
class Place:
    def __init__(self, city_name: str):
        """Initializes a Place object with the closest city match."""
        self.location = get_closest_city_matches(city_name)[0] if get_closest_city_matches(city_name) else None #Handle empty list
        if self.location:
